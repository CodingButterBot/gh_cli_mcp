...
export const prTools = {
    ...
    view: new Tool('gh_pr_view', baseGitHubParamsSchema.extend({
    ...
    create: new Tool('gh_pr_create', pullRequestParamsSchema, async (params, sessionId) => {
        return await execGitHubCommand('pr', 'create', params, sessionId);
    }, { description: 'Create a new pull request' }),
    close: new Tool('gh_pr_close', baseGitHubParamsSchema.extend({
        number: z.number().describe('Pull request number'),
...
export const issueTools = {
    ...
    view: new Tool('gh_issue_view', baseGitHubParamsSchema.extend({
    ...
    create: new Tool('gh_issue_create', issueParamsSchema, async (params, sessionId) => {
        return await execGitHubCommand('issue', 'create', params, sessionId);
    }, { description: 'Create a new issue' }),
    close: new Tool('gh_issue_close', baseGitHubParamsSchema.extend({
        number: z.number().describe('Issue number'),
        comment: z.string().optional().describe('Add a closing comment')
    }), async (params, sessionId) => {
...
export const repoTools = {
    ...
    list: new Tool('gh_repo_list', z.object({
...
export const projectTools = {
    ...
    list: new Tool('gh_project_list', baseGitHubParamsSchema.extend({
    ...
    create: new Tool('gh_project_create', baseGitHubParamsSchema.extend({
    ...
    edit: new Tool('gh_project_edit', baseGitHubParamsSchema.extend({
        number: z.number().describe('Project number'),
...
export const workflowTools = {
    ...
    view: new Tool('gh_workflow_view', baseGitHubParamsSchema.extend({
    ...
    run: new Tool('gh_workflow_run', baseGitHubParamsSchema.extend({
        name: z.string().describe('Name or ID of the workflow'),
    ...
    disable: new Tool('gh_workflow_disable', baseGitHubParamsSchema.extend({
        name: z.string().describe('Name or ID of the workflow')
    }), async (params, sessionId) => {
        return await execGitHubCommand('workflow', 'disable', params, sessionId);
    }, { description: 'Disable a workflow' }),
    enable: new Tool('gh_workflow_enable', baseGitHubParamsSchema.extend({
        name: z.string().describe('Name or ID of the workflow')
    }), async (params, sessionId) => {
...
export const releaseTools = {
    ...
    view: new Tool('gh_release_view', baseGitHubParamsSchema.extend({
    ...
    create: new Tool('gh_release_create', baseGitHubParamsSchema.extend({
    ...
    delete: new Tool('gh_release_delete', baseGitHubParamsSchema.extend({
