...
export const prTools = {
    list: new Tool('gh_pr_list', filterParamsSchema, async (params) => {
    ...
    create: new Tool('gh_pr_create', pullRequestParamsSchema, async (params) => {
...
export const issueTools = {
    list: new Tool('gh_issue_list', filterParamsSchema, async (params) => {
    ...
    create: new Tool('gh_issue_create', issueParamsSchema, async (params) => {
